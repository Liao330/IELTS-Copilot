...
from app.routers import agents, conversations, messages, files, notes, settings, homeworks, vocabulary, listening_practice, speech, dictation, feedback, schedule, writing_templates, reports, study_plan, writing_materials, speaking_corrections, speaking_phrases, template_vocab, speaking_materials
...
app.include_router(writing_materials.router)
app.include_router(speaking_corrections.router)
app.include_router(speaking_phrases.router)
app.include_router(template_vocab.router)
app.include_router(speaking_materials.router)
